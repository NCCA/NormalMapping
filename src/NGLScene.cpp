...
void NGLScene::keyPressEvent(QKeyEvent *_event)
{
  ...
  case Qt::Key_S:
    ...
    break;
  case Qt::Key_1:
    setLight("light[0]", Mode::Enable);
    break;
  case Qt::Key_2:
    setLight("light[0]", Mode::Disable);
    break;
  case Qt::Key_3:
    setLight("light[1]", Mode::Enable);
    break;
  case Qt::Key_4:
    setLight("light[1]", Mode::Disable);
    break;
  case Qt::Key_5:
    setLight("light[2]", Mode::Enable);
    break;
  case Qt::Key_6:
    setLight("light[2]", Mode::Disable);
    break;
  case Qt::Key_T:
    m_showNormals ^= true;
    break;
